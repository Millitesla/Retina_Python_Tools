...
expName = u'Stimuli'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/ruff/OneDrive/Retina Python Tools/Stimuli.psyexp',
...
grating = visual.GratingStim(
    ...
    tex=u'sin', mask=None,
    ori=0, pos=(1, 0), size=(0.5, 0.5), sf=None, phase=0.0,
...
trialComponents = [ISI, grating, dots]
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    # *dots* updates
    if t >= 3 and dots.status == NOT_STARTED:
        # keep track of start time/frame for later
        dots.tStart = t
